import ButlerHeader from "@/components/butler/ButlerHeader";
        ...
        <main className="pt-28 lg:pt-32">
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-lg mx-auto text-center">
              ...
              <p className="text-muted-foreground mb-8">Start shopping to support Butler athletes!</p>
              <Link to="/butler">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
                  ...
                  <div className="flex gap-4 lg:gap-6">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between gap-4">
                        <div>
                          <span className="text-xs font-medium uppercase tracking-wider" style={{ color: BU_BLUE }}>{item.category}</span>
                      ...
                      <p className="text-xs mt-1" style={{ color: BU_BLUE }}>
            ...
            <div className="lg:col-span-1">
              <div className="bg-card border border-border rounded-xl p-6 sticky top-32">
                ...
                <div className="mt-4 p-3 rounded-lg" style={{ backgroundColor: `${BU_BLUE}12` }}>
                  <div className="flex items-center gap-2 mb-1">
                    <Heart className="w-4 h-4" style={{ color: BU_BLUE }} />
                    <span className="text-sm font-semibold" style={{ color: BU_BLUE }}>FanPact NIL Contribution</span>
                  </div>
                  <p className="text-lg font-bold" style={{ color: BU_BLUE }}>${nilContribution.toFixed(2)}</p>
                  <p className="text-[10px] text-muted-foreground mt-0.5">
                    Calculated from your pre-tax &amp; shipping subtotal to support Butler athletes
                  </p>
                </div>
