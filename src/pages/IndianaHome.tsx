...
import IndianaHeader from "@/components/indiana/IndianaHeader";
import IndianaFooter from "@/components/indiana/IndianaFooter";
...
const categories = [
  { name: "Electronics", image: categoryElectronics, productCount: 1250, link: "/indiana/category/electronics" },
  { name: "Fashion & Apparel", image: categoryFashion, productCount: 3420, link: "/indiana/category/fashion" },
  { name: "Home & Garden", image: categoryHome, productCount: 2180, link: "/indiana/category/home" },
  { name: "Beauty & Personal Care", image: categoryBeauty, productCount: 1890, link: "/indiana/category/beauty" },
  { name: "Sports & Outdoors", image: categorySports, productCount: 1560, link: "/indiana/category/sports" },
  { name: "Toys & Games", image: categoryToys, productCount: 980, link: "/indiana/category/toys" },
  { name: "Food & Grocery", image: categoryFood, productCount: 2340, link: "/indiana/category/food" },
  { name: "Pet Supplies", image: categoryPets, productCount: 720, link: "/indiana/category/pets" },
  { name: "Automotive", image: categoryAutomotive, productCount: 1120, link: "/indiana/category/automotive" },
  { name: "Health & Wellness", image: categoryHealth, productCount: 1650, link: "/indiana/category/health" },
  { name: "Jewelry & Watches", image: categoryJewelry, productCount: 890, link: "/indiana/category/jewelry" },
  { name: "Merchandise", image: categoryMerchandise, productCount: 450, link: "/indiana/category/merchandise" },
];

const athletes = [
  { name: "Jordan Davis", sport: "Basketball", position: "Shooting Guard", image: athlete1 },
  { name: "Emily Carter", sport: "Soccer", position: "Midfielder", image: athlete2 },
  { name: "Ryan Brooks", sport: "Baseball", position: "Shortstop", image: athlete3 },
];

const teams = [
  { name: "Football", icon: "🏈", athletes: 85, link: "#" },
  { name: "Basketball", icon: "🏀", athletes: 15, link: "#" },
  { name: "Baseball", icon: "⚾", athletes: 35, link: "#" },
  { name: "Soccer", icon: "⚽", athletes: 28, link: "#" },
  { name: "Volleyball", icon: "🏐", athletes: 18, link: "#" },
...
const IndianaHome = () => {
  const [nilCounter, setNilCounter] = useState(98320);

  useEffect(() => {
    const interval = setInterval(() => {
      setNilCounter(prev => prev + Math.floor(Math.random() * 12) + 3);
    }, 3000);
        ...
        <section className="relative min-h-[45vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 w-full px-4 sm:px-6 lg:px-10 pt-10 lg:pt-14">
            <h1 className="font-display text-4xl sm:text-5xl lg:text-7xl text-background leading-[0.9] mb-5 w-full tracking-tight">
              <span className="block">SUPPORT INDIANA ATHLETICS AND</span>
            ...
            <p className="text-base sm:text-lg lg:text-xl text-background/70 w-full mb-3">
              By simply shopping for everyday products, you support your favorite Hoosier teams & players at no additional cost.
            </p>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 lg:gap-6 mt-4 pt-4 border-t border-background/10 max-w-2xl">
              ...
              <div><div className="font-display text-3xl lg:text-4xl text-primary">40+</div><div className="text-sm text-background/60">Athletes</div></div>
              <div><div className="font-display text-3xl lg:text-4xl text-primary">12</div><div className="text-sm text-background/60">Sports</div></div>
              <div><div className="font-display text-3xl lg:text-4xl text-primary">10K+</div><div className="text-sm text-background/60">Products</div></div>
            </div>
          </div>
        </section>
        ...
        <section id="athletes" className="py-20 lg:py-32 bg-background">
          <div className="container mx-auto px-4">
            <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between mb-12 lg:mb-16">
              <div>
                <span className="text-primary font-semibold uppercase tracking-wider text-sm">Meet the Hoosiers</span>
        ...
        <section className="py-20 lg:py-28 bg-background relative overflow-hidden">
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h2 className="font-display text-4xl lg:text-6xl text-foreground mb-6">JOIN THE HOOSIER NATION</h2>
