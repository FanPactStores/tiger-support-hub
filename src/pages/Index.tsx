  ...
  return (
    <div>
      ...
      <section className="relative h-[70vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-t from-dark/90 via-dark/65 to-dark/40" />
        <div className="relative z-10 text-center px-4 max-w-3xl mx-auto animate-fade-in-up">
          ...
          <p className="text-base sm:text-lg text-secondary/80 mb-2 font-body max-w-2xl mx-auto">
          ...
          <a
            href="#conferences"
            className="inline-flex items-center justify-center gap-2 bg-secondary text-foreground font-display font-bold text-lg px-10 py-4 rounded-lg transition-all duration-300 hover:bg-secondary/90 shadow-lg"
          >
      ...
      {/* ===== SECTION 3: SCHOOL SELECTION (CONFERENCES) ===== */}
      <section id="conferences" className="py-16 bg-secondary">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-sm text-muted-foreground mb-10 max-w-lg mx-auto">
            Pick your school to enter its dedicated storefront and start supporting athletes.
          </p>
