...
const ButlerFooter = () => {
  const footerLinks = {
    Platform: [
      { label: "Athletes", href: "/butler#athletes" },
      { label: "Teams", href: "/butler/football" },
      { label: "Shop", href: "/butler#shop" },
      { label: "Sponsors", href: "/butler/sponsors" },
    ],
    Support: [
      { label: "FAQ", href: "#" },
      { label: "Contact", href: "#" },
    ...
    <footer className="bg-foreground pt-16 lg:pt-20 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 lg:gap-8 pb-12 border-b border-background/10">
          <div className="lg:col-span-1">
            ...
            <p className="text-background/60 text-sm mb-6">
              Connecting fans with Butler athletes through exclusive merchandise and authentic engagement.
            </p>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center pt-6 gap-4">
          <p className="text-background/40 text-sm">© 2025 FanPact Butler. All rights reserved.</p>
