...
export const IndianaDisclaimerBanner = () => {
        ...
        <div className="flex items-center gap-3">
          <div className="flex-1 min-w-0">
            <p className="text-background/95 text-sm md:text-base font-semibold leading-relaxed">
              We donate <span className="text-primary font-bold">80%</span> of net earnings from qualifying purchases to support Indiana student-athletes. Thank you for shopping with purpose!{" "}
