...
const IndianaFooter = () => {
  const footerLinks = {
    Platform: [
      { label: "Athletes", href: "/indiana#athletes" },
      { label: "Teams", href: "/indiana#teams" },
      { label: "Shop", href: "/indiana#shop" },
    ],
    Support: [
      { label: "FAQ", href: "#" },
      { label: "Contact", href: "#" },
      ...
      <div className="container mx-auto px-4">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <span className="block text-xs text-primary font-semibold -mt-1">INDIANA</span>
              </div>
            </div>
            <p className="text-background/60 text-sm mb-6">
              Connecting fans with Indiana Hoosier athletes through exclusive merchandise and authentic engagement.
            </p>
        ...
        <div className="py-6 border-b border-background/10">
          <p className="text-background/50 text-xs font-semibold leading-relaxed text-center max-w-2xl mx-auto">
            Unofficial Fan Support Site – Fanpact is not affiliated with or endorsed by Indiana University. We donate 80% of net earnings from purchases here to support Indiana student-athletes.{" "}
            <Link to="/disclaimer" className="text-primary hover:underline">Full Disclaimer →</Link>
          </p>
        </div>
        <div className="flex flex-col sm:flex-row justify-between items-center pt-6 gap-4">
          <p className="text-background/40 text-sm">© 2025 FanPact Indiana. All rights reserved.</p>
