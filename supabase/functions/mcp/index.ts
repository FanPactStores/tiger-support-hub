...
var schools = [
  ...
  { id: "mississippi-state", name: "Mississippi State University", conference: "SEC", mascot: "Bulldogs", primaryColor: "#660000", secondaryColor: "#FFFFFF", athleteCount: 420, productCount: 1e3 },
  ...
  { id: "tcu", name: "Texas Christian University", conference: "Big 12", mascot: "Horned Frogs", primaryColor: "#4D1979", secondaryColor: "#A3A9AC", athleteCount: 420, productCount: 1e3 },
  ...
  { id: "cincinnati", name: "University of Cincinnati", conference: "Big 12", mascot: "Bearcats", primaryColor: "#E00122", secondaryColor: "#000000", athleteCount: 420, productCount: 1e3 },
  ...
  { id: "georgia-tech", name: "Georgia Tech", conference: "ACC", mascot: "Yellow Jackets", primaryColor: "#B3A369", secondaryColor: "#003057", athleteCount: 420, productCount: 1e3 },
  ...
  // Independents
  { id: "army", name: "United States Military Academy", conference: "Independent", mascot: "Black Knights", primaryColor: "#000000", secondaryColor: "#D3BC8D", athleteCount: 400, productCount: 1e3 },
  { id: "navy", name: "United States Naval Academy", conference: "Independent", mascot: "Midshipmen", primaryColor: "#00205B", secondaryColor: "#C5B783", athleteCount: 400, productCount: 1e3 },
...
// src/data/mizzouCategoryData.ts
function don(price) {
...
var electronics = {
  ...
  products: [
    { id: pid(), name: "Sony WH-1000XM5 Wireless Headphones", brand: "Sony", isNameBrand: true, price: 348, rating: 4.8, reviews: 12847, image: "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=600&h=600&fit=crop", subcategory: "headphones-earbuds", nilDonation: don(348) },
    ...
    { id: pid(), name: "Bose SoundLink Flex Speaker", brand: "Bose", isNameBrand: true, price: 149, rating: 4.6, reviews: 6241, image: "https://images.unsplash.com/photo-1589003077984-894e133dabab?w=600&h=600&fit=crop", subcategory: "speakers", nilDonation: don(149) },
    ...
    { id: pid(), name: "Apple iPad (10th Gen)", brand: "Apple", isNameBrand: true, price: 349, rating: 4.8, reviews: 18234, image: "https://images.unsplash.com/photo-1585790050230-5dd28404ccb9?w=600&h=600&fit=crop", subcategory: "tablets-ereaders", nilDonation: don(349) },
...
var fashion = {
  ...
  products: [
    { id: pid(), name: "Nike Dri-FIT Training Tee", brand: "Nike", isNameBrand: true, price: 35, rating: 4.7, reviews: 8234, image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&h=600&fit=crop", subcategory: "mens-clothing", nilDonation: don(35) },
    ...
    { id: pid(), name: "Levi's 501 Original Fit Jeans", brand: "Levi's", isNameBrand: true, price: 69.5, rating: 4.6, reviews: 15678, image: "https://images.unsplash.com/photo-1542272604-787c3835535d?w=600&h=600&fit=crop", subcategory: "mens-clothing", nilDonation: don(69.5) },
    ...
    { id: pid(), name: "Champion Reverse Weave Hoodie", brand: "Champion", isNameBrand: true, price: 60, rating: 4.7, reviews: 9876, image: "https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=600&h=600&fit=crop", subcategory: "outerwear", nilDonation: don(60) },
    { id: pid(), name: "Nike Air Force 1 '07", brand: "Nike", isNameBrand: true, price: 115, rating: 4.9, reviews: 28345, image: "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?w=600&h=600&fit=crop", subcategory: "shoes", nilDonation: don(115) },
    { id: pid(), name: "Adidas Tiro Track Pants", brand: "Adidas", isNameBrand: true, price: 45, rating: 4.5, reviews: 7654, image: "https://images.unsplash.com/photo-1591195853828-11db59a44f6b?w=600&h=600&fit=crop", subcategory: "activewear", nilDonation: don(45) },
    ...
    { id: pid(), name: "Nike Heritage86 Cap", brand: "Nike", isNameBrand: true, price: 24, rating: 4.6, reviews: 6543, image: "https://images.unsplash.com/photo-1588850561407-ed78c334e67a?w=600&h=600&fit=crop", subcategory: "accessories", nilDonation: don(24) },
    ...
    { id: pid(), name: "Hanes EcoSmart Fleece Sweatshirt", brand: "Hanes", isNameBrand: true, price: 16, rating: 4.4, reviews: 19876, image: "https://images.unsplash.com/photo-1578587018452-892bacefd3f2?w=600&h=600&fit=crop", subcategory: "mens-clothing", nilDonation: don(16) },
    { id: pid(), name: "StridePro Casual Sneakers", brand: "StridePro", isNameBrand: false, price: 42.99, rating: 4, reviews: 1876, image: "https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?w=600&h=600&fit=crop", subcategory: "shoes", nilDonation: don(42.99) }
  ]
};
var home = {
  slug: "home",
  ...
  products: [
    ...
    { id: pid(), name: "Weber Spirit II E-310 Gas Grill", brand: "Weber", isNameBrand: true, price: 449, rating: 4.7, reviews: 4567, image: "https://images.unsplash.com/photo-1529636798458-92182e662485?w=600&h=600&fit=crop", subcategory: "garden-outdoor", nilDonation: don(449) },
    ...
    { id: pid(), name: "Threshold Table Lamp with Shade", brand: "Threshold", isNameBrand: false, price: 42, rating: 4.3, reviews: 1987, image: "https://images.unsplash.com/photo-1507473885765-e6ed057ab6fe?w=600&h=600&fit=crop", subcategory: "lighting", nilDonation: don(42) },
    { id: pid(), name: "Artisan Ceramic Vase Set", brand: "Artisan Home", isNameBrand: false, price: 38.5, rating: 4.4, reviews: 1543, image: "https://images.unsplash.com/photo-1612196808214-b8e1d6145a8c?w=600&h=600&fit=crop", subcategory: "decor", nilDonation: don(38.5) },
...
var beauty = {
  ...
  filters: [
    ...
    { key: "brand", label: "Brand", options: ["CeraVe", "Neutrogena", "Dove", "Old Spice", "Olay", "L'Or\xE9al"] },
  ...
  products: [
    ...
    { id: pid(), name: "L'Or\xE9al Voluminous Mascara", brand: "L'Or\xE9al", isNameBrand: true, price: 9.99, rating: 4.4, reviews: 14567, image: "https://images.unsplash.com/photo-1512496015851-a90fb38ba796?w=600&h=600&fit=crop", subcategory: "makeup", nilDonation: don(9.99) },
    ...
    { id: pid(), name: "TRESemm\xE9 Keratin Smooth Shampoo", brand: "TRESemm\xE9", isNameBrand: true, price: 6.99, rating: 4.4, reviews: 9876, image: "https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?w=600&h=600&fit=crop", subcategory: "haircare", nilDonation: don(6.99) },
...
var sports = {
  ...
  products: [
    { id: pid(), name: "Yeti Rambler 26oz Bottle", brand: "Yeti", isNameBrand: true, price: 40, rating: 4.8, reviews: 15678, image: "https://images.unsplash.com/photo-1602143407151-7111542de6e8?w=600&h=600&fit=crop", subcategory: "exercise-equipment", nilDonation: don(40) },
    ...
    { id: pid(), name: "The North Face Jester Backpack", brand: "The North Face", isNameBrand: true, price: 69, rating: 4.6, reviews: 12345, image: "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600&h=600&fit=crop", subcategory: "camping-hiking", nilDonation: don(69) },
    ...
    { id: pid(), name: "Speedo Unisex Swim Goggles", brand: "Speedo", isNameBrand: true, price: 15, rating: 4.6, reviews: 7890, image: "https://images.unsplash.com/photo-1530549387789-4c1017266635?w=600&h=600&fit=crop", subcategory: "water-sports", nilDonation: don(15) },
...
var health = {
  ...
  products: [
    ...
    { id: pid(), name: "Theragun Mini Massage Gun", brand: "Theragun", isNameBrand: true, price: 199, rating: 4.7, reviews: 8765, image: "https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?w=600&h=600&fit=crop", subcategory: "massage-recovery", nilDonation: don(199) },
    ...
    { id: pid(), name: "doTERRA Lavender Essential Oil", brand: "doTERRA", isNameBrand: true, price: 28, rating: 4.6, reviews: 9876, image: "https://images.unsplash.com/photo-1608571423902-eed4a5ad8108?w=600&h=600&fit=crop", subcategory: "essential-oils", nilDonation: don(28) },
...
var jewelry = {
  ...
  products: [
    ...
    { id: pid(), name: "Ray-Ban Aviator Classic Sunglasses", brand: "Ray-Ban", isNameBrand: true, price: 163, rating: 4.8, reviews: 23456, image: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&h=600&fit=crop", subcategory: "sunglasses", nilDonation: don(163) },
    ...
    { id: pid(), name: "Pandora Moments Bracelet", brand: "Pandora", isNameBrand: true, price: 65, rating: 4.7, reviews: 9876, image: "https://images.unsplash.com/photo-1515562141589-67f0d569b6e5?w=600&h=600&fit=crop", subcategory: "bracelets", nilDonation: don(65) },
    { id: pid(), name: "Swarovski Crystal Stud Earrings", brand: "Swarovski", isNameBrand: true, price: 49, rating: 4.6, reviews: 6543, image: "https://images.unsplash.com/photo-1535632066927-ab7c9ab60908?w=600&h=600&fit=crop", subcategory: "earrings", nilDonation: don(49) },
    ...
    { id: pid(), name: "Ray-Ban Wayfarer Classic", brand: "Ray-Ban", isNameBrand: true, price: 154, rating: 4.8, reviews: 15678, image: "https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=600&h=600&fit=crop", subcategory: "sunglasses", nilDonation: don(154) },
    ...
    { id: pid(), name: "Pandora Signature Necklace", brand: "Pandora", isNameBrand: true, price: 75, rating: 4.7, reviews: 4567, image: "https://images.unsplash.com/photo-1515562141589-67f0d569b6e5?w=600&h=600&fit=crop", subcategory: "necklaces", nilDonation: don(75) },
...
var merchandise = {
  ...
  products: [
    { id: pid(), name: "Nike Mizzou Dri-FIT Tee", brand: "Nike", isNameBrand: true, price: 35, rating: 4.7, reviews: 8765, image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&h=600&fit=crop", subcategory: "tshirts", nilDonation: don(35) },
    ...
    { id: pid(), name: "Yeti Mizzou Rambler Tumbler 20oz", brand: "Yeti", isNameBrand: true, price: 38, rating: 4.8, reviews: 4321, image: "https://images.unsplash.com/photo-1514228742587-6b1558fcca3d?w=600&h=600&fit=crop", subcategory: "drinkware", nilDonation: don(38) },
    ...
    { id: pid(), name: "Colosseum Mizzou Women's V-Neck", brand: "Colosseum", isNameBrand: true, price: 28, rating: 4.4, reviews: 2345, image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=600&h=600&fit=crop", subcategory: "tshirts", nilDonation: don(28) },
    ...
    { id: pid(), name: "Nike Mizzou Heritage86 Adjustable Hat", brand: "Nike", isNameBrand: true, price: 27, rating: 4.7, reviews: 4567, image: "https://images.unsplash.com/photo-1588850561407-ed78c334e67a?w=600&h=600&fit=crop", subcategory: "hats-caps", nilDonation: don(27) },
...
// src/data/indianaCategoryData.ts
function rebranded(cat) {
  return {
    ...cat,
    description: cat.description.replace(/Missouri/g, "Indiana").replace(/Mizzou/g, "Indiana").replace(/Missouri athletes/g, "Hoosier athletes").replace(/Mizzou NIL/g, "Indiana NIL").replace(/Mizzou athletes/g, "Hoosier athletes"),
    products: cat.products.map((p) => ({
      ...p,
      // Keep same products — only rebrand merchandise names
      name: cat.slug === "merchandise" ? p.name.replace(/Mizzou/g, "Indiana").replace(/Tigers/g, "Hoosiers").replace(/TigerPride/g, "HoosierPride").replace(/MizzouFanShop/g, "IUFanShop").replace(/GoldStripe/g, "CrimsonStripe") : p.name
    }))
  };
}
var allCategories2 = allCategories.map(rebranded);

// src/data/butlerCategoryData.ts
function rebranded2(cat) {
  return {
    ...cat,
    description: cat.description.replace(/University of Missouri/g, "Butler University").replace(/Missouri/g, "Butler").replace(/Mizzou/g, "Butler").replace(/Tigers/g, "Bulldogs").replace(/Tiger/g, "Bulldog"),
    products: cat.products.map((p) => ({
      ...p,
      name: cat.slug === "merchandise" ? p.name.replace(/Mizzou/g, "Butler").replace(/Tigers/g, "Bulldogs").replace(/TigerPride/g, "BulldogPride").replace(/MizzouFanShop/g, "ButlerFanShop").replace(/GoldStripe/g, "BlueStripe") : p.name
    }))
  };
}
var allCategories3 = allCategories.map(rebranded2);

// src/lib/mcp/tools/list-categories.ts
var bySchool = {
  missouri: allCategories,
  mizzou: allCategories,
  indiana: allCategories2,
  butler: allCategories3
};
